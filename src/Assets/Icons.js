...
export const SearchIcon = ({height, width,stroke="white"}) => (
  <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search" width={width} height={height} viewBox="0 0 24 24" stroke-width="2" stroke={stroke} fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
export const FeedIcon = ({height,width,stroke="#2c3e50"})  => (
  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid-3x3" width={width} height={height} viewBox="0 0 24 24" strokeWidth="2.3" stroke={stroke} fill="none" strokeLinecap="round" strokeLinejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
  <path d="M3 8h18" />
  <path d="M3 16h18" />
  <path d="M8 3v18" />
